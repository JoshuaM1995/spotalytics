    ...
    <Page>
      <Panel shaded bordered bodyFill className="panel-light">
        ...
        <div style={{ padding: "0 20px" }}>
          ...
          <Content
            style={{
              display: activeTab === Tab.ALBUMS ? "block" : "none",
              marginTop: "20px",
            }}
          >
          ...
          <Content
            style={{
              display: activeTab === Tab.TOP_TRACKS ? "block" : "none",
              marginTop: "20px",
            }}
          >
            {artistId && (
          ...
          <Content
            style={{
              display: activeTab === Tab.RELATED_ARTISTS ? "block" : "none",
              marginTop: "20px",
            }}
          >
            {artistId && (
          ...
          <Content
            style={{
              display: activeTab === Tab.BIOGRAPHY ? "block" : "none",
              marginTop: "20px",
            }}
          >
            <ArtistBiography

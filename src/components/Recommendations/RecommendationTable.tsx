...
const RecommendedTracksTable = ({
  recommendations,
  tableState,
  tableStateDispatch,
  playlistNameOverride,
}: RecommendationTableProps): JSX.Element => {
  let initialPlaylistName;
  if (playlistNameOverride) {
    initialPlaylistName = playlistNameOverride;
  } else {
    initialPlaylistName = `Spotalytics Recommendations Playlist (${moment().format('YYYY-MM-DD')})`;
  }
...
export default RecommendedTracksTable;
